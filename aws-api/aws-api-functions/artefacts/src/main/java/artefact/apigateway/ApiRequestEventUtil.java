...
public interface ApiRequestEventUtil {
    ...
    default Map fromBodyToMap(final Logger logger,
                              final APIGatewayV2HTTPEvent event) throws BadException {
        return fromBodyToObject(logger, event, Map.class);
    }

    default <T> T fromBodyToObject(final Logger logger, final APIGatewayV2HTTPEvent event,
...
//     private boolean fillWithData(final ObjectNode node, final String onSuccess, final String onFailure,
//                                         final String raw)
//             throws IOException
//     {
//         try {
