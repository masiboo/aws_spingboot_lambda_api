...
public class S3Service {
  ...
  /**
   * Generate a S3 Signed Url for creating an object using PUT request. with metadata
   *
   * @param bucket {@link String}
   * @param key {@link String}
   * @param duration {@link Duration}
   * @return {@link URL}
   * @return metadat {@link String}
   */
  public URL presignPutUrl(final String bucket, final String key, final Duration duration, Map<String, String> metadata) {
  ...
  public void setObjectTag(final S3Client s3, final String bucket, final String key,
    ...
    setObjectTags(s3, bucket, key, tagList);
  }
