...
public interface DbKeys {
  ...
  enum Type {
    ...
    CERTIFICATE("ARTEFACT#CERTIFICATE"),
    DOCUMENT("ARTEFACT#DOCUMENT"),
    BWLOGO("ARTEFACT#BWLOGO"),
    COLOURLOGO("ARTEFACT#COLOURLOGO"),

    SOUND("ARTEFACT#SOUND"),
    MULTIMEDIA("ARTEFACT#MULTIMEDIA");
  ...
  default Map<String, AttributeValue> keysDocument( String documentId,
    ...
    return childdocument.isPresent()
        ? keysGeneric(PREFIX_DOCS + documentId,
   ...
   * @return {@link Map}
   */
  default Map<String, AttributeValue> keysDocumentFormats( String documentId,
  ...
  default Map<String, AttributeValue> keysDocumentTag(String siteId, String documentId,
      final String tagKey) {
    return keysGeneric( PREFIX_DOCS + documentId,
...
//  }
   ...
   * @return {@link Map}
   */
  default Map<String, AttributeValue> keysGeneric(String pkKey, String pk,
  ...
  default String getTypeKey(String docType){
    Type keyByDocType;
    try{
