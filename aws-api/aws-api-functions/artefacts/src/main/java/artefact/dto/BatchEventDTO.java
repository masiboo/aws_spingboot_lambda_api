...
public class BatchEventDTO implements Serializable
{
     ...
     * @param account
     */
    public BatchEventDTO(String version, String id, String detailType, String source, String account, String time, String region, List<Object> resources, BatchEventDetail detail) {
        super();
