...
public class ArtefactItemInput implements Serializable
{
    ...
    public String toString() {
        ...
        sb.append(ArtefactItemInput.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("storage");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof ArtefactItemInput) == false) {
            return false;
        }
        ArtefactItemInput rhs = ((ArtefactItemInput) other);
        return ((((((this.path == rhs.path)||((this.path!= null)&&this.path.equals(rhs.path)))&&((this.storage == rhs.storage)||((this.storage!= null)&&this.storage.equals(rhs.storage))))&&((this.filename == rhs.filename)||((this.filename!= null)&&this.filename.equals(rhs.filename))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.contentType == rhs.contentType)||((this.contentType!= null)&&this.contentType.equals(rhs.contentType))));
    }
