...
public class ArtefactItem implements Serializable
{
     ...
     * @param contentType
     */
    public ArtefactItem(long id, String storage, String path, String filename, String contentType, long totalPages, long pageIndex, String artefactType) {
        super();
        this.id = id;
    ...
    public String toString() {
        ...
        sb.append(ArtefactItem.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
        sb.append(this.id);
        sb.append(',');
    ...
    public boolean equals(Object other) {
        ...
        return ((((((((((this.path == rhs.path) || ((this.path != null) && this.path.equals(rhs.path))) && ((this.filename == rhs.filename) || ((this.filename != null) && this.filename.equals(rhs.filename)))) && (this.pageIndex == rhs.pageIndex)) && ((this.artefactType == rhs.artefactType) || ((this.artefactType != null) && this.artefactType.equals(rhs.artefactType)))) && (this.totalPages == rhs.totalPages)) && (this.id == rhs.id)) && ((this.storage == rhs.storage) || ((this.storage != null) && this.storage.equals(rhs.storage)))) && ((this.additionalProperties == rhs.additionalProperties) || ((this.additionalProperties != null) && this.additionalProperties.equals(rhs.additionalProperties)))) && ((this.contentType == rhs.contentType) || ((this.contentType != null) && this.contentType.equals(rhs.contentType))));
    }
