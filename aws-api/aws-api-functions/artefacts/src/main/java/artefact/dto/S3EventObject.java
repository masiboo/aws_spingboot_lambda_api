...
public class S3EventObject implements Serializable
{
     ...
     * @param sequencer
     */
    public S3EventObject(String key, Long size, String etag, String versionId, String sequencer) {
        super();
        this.key = key;
        this.size = size;
        this.etag = etag;
    ...
    public String toString() {
        ...
        sb.append(S3EventObject.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("key");
        sb.append('=');
    ...
    public boolean equals(java.lang.Object other) {
        ...
        if ((other instanceof S3EventObject) == false) {
            return false;
        }
        S3EventObject rhs = ((S3EventObject) other);
