...
public class LastModUser implements Serializable {
     ...
     * @param username
     */
    public LastModUser(long id, String wipoId, String username, String cognitoId) {
        super();
        this.id = id;
        this.wipoId = wipoId;
    ...
    public LastModUser withWipoId(String wipoId) {
        this.wipoId = wipoId;
        return this;
    }
    ...
    public String toString() {
        ...
        sb.append(LastModUser.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
        sb.append(this.id);
        sb.append(',');
