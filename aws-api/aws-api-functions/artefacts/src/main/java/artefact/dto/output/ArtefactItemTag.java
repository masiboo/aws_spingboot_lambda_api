...
public class ArtefactItemTag implements Serializable
{
    ...
    public ArtefactItemTag() {
        this.insertedDate = DateUtils.getCurrentUtcDateTimeStr();
    }
    ...
    public String toString() {
        ...
        sb.append(ArtefactItemTag.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("id");
        sb.append('=');
    ...
    public boolean equals(Object other) {
        ...
        return (((((((this.insertedDate == rhs.insertedDate)||((this.insertedDate!= null)&&this.insertedDate.equals(rhs.insertedDate)))&&((this.id == rhs.id)||((this.id!= null)&&this.id.equals(rhs.id))))&&((this.additionalProperties == rhs.additionalProperties)||((this.additionalProperties!= null)&&this.additionalProperties.equals(rhs.additionalProperties))))&&((this.type == rhs.type)||((this.type!= null)&&this.type.equals(rhs.type))))&&((this.value == rhs.value)||((this.value!= null)&&this.value.equals(rhs.value))))&&((this.key == rhs.key)||((this.key!= null)&&this.key.equals(rhs.key))));
    }
