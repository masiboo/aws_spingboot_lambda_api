...
@JsonPropertyOrder({ "id", "path", "filename", "status", "s3_signed_url", "creationDate", "updatedDate", "artefactId",
		"requestId", "batchSequence" })
...
public class ArtefactJob implements Serializable {
	...
	public ArtefactJob() {
		...
		if (this.updatedDate == null) {
			this.updatedDate = DateUtils.getCurrentDatetimeUtc();
		}
	}
	...
	public String toString() {
		...
		sb.append(ArtefactJob.class.getName())
			.append('@')
	...
	public boolean equals(Object other) {
		...
		return ((((((((((this.path == rhs.path) || ((this.path != null) && this.path.equals(rhs.path)))
				...
				&& ((this.artefactId == rhs.artefactId)
						|| ((this.artefactId != null) && this.artefactId.equals(rhs.artefactId))))
				&& ((this.id == rhs.id) || ((this.id != null) && this.id.equals(rhs.id))))
				&& ((this.updatedDate == rhs.updatedDate)
						|| ((this.updatedDate != null) && this.updatedDate.equals(rhs.updatedDate))))
				...
				&& ((this.s3SignedUrl == rhs.s3SignedUrl)
						|| ((this.s3SignedUrl != null) && this.s3SignedUrl.equals(rhs.s3SignedUrl))))
