...
@AllArgsConstructor
@Slf4j
public class WSConnectionHandler implements Function<APIGatewayV2WebSocketEvent, APIGatewayV2WebSocketResponse> {
	...
	public APIGatewayV2WebSocketResponse apply(APIGatewayV2WebSocketEvent wsEvent) {
		...
		// TODO Have the logic to Add the connection details from the Dynamo/RDS
		APIGatewayV2WebSocketResponse wsResp = new APIGatewayV2WebSocketResponse();
		wsResp.setBody("Connected successfully");
