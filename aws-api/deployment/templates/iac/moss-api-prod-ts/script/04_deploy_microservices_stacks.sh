...
#    npx aws-cdk deploy Aws*AwsInfraECSClusterStack --require-approval never

    npx aws-cdk deploy Aws*AwsCoreDBAccessStack --require-approval never
    npx aws-cdk deploy Aws*AwsCoreMediaProcessStack --require-approval never
#    npx aws-cdk deploy Aws*AwsCoreMirisProxyStack --require-approval never
#    npx aws-cdk deploy Aws*AwsCoreEmailSvctack --require-approval never
