...
export class CrossRegionBaseStack extends cdk.Stack implements ICommonHelper, ICommonGuardian {
    ...
    constructor(appContext: AppContext, stackConfig: StackConfig) {
        let newProps = CrossRegionBaseStack.getStackCommonProps(appContext, stackConfig);
    ...
    public resolveResourceName(resource: string): string {
        return `${resource}-${this.stackConfig.Name}`;
    }
