...
const CDK_VER = '@2';
const WORK_DIR = './iac/Aws-api-prod-ts';
...
export interface ActionProps {
    ...
    Detail:  SourceKindCodeStarProps | SourceKindGithubProps | ApproveKindManualProps | BuildKindCodeBuildProps | DeployKindS3BucketProps;
}
